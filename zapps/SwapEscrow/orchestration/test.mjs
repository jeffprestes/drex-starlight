...
describe("SwapShield", async function () {
		...
		describe("Second Call", async function () {
			...
			it("should call deposit again", async () => {
				try {
					...
					const { tx } = await deposit(config.web3.options.defaultAccount, 25);
					if (tx.event) {
						console.log(`Merkle tree event returnValues:`);
						console.log(tx.returnValues[0]);
					}
	...
	// eslint-disable-next-line func-names
	describe("deposit_tokens", async function () {
		this.timeout(3660000);
		try {
			await web3.connect();
		} catch (err) {
		...
		describe("First call", async function () {
			this.timeout(3660000);
			it("should call deposit_tokens", async () => {
				try {
					// this starts up the merkle tree's event filter
					await startEventFilter("SwapShield");
					// this calls your function! It returns the tx from the shield contract
		...
		describe("Second Call", async function () {
			this.timeout(3660000);
			it("should call deposit_tokens again", async () => {
				try {
					// this calls your function a second time for incremental cases
					const { tx } = await deposit_tokens(
						config.web3.options.defaultAccount,
						188,
						102
					);
	...
	// eslint-disable-next-line func-names
	describe("startSwap", async function () {
		this.timeout(3660000);
		try {
			await web3.connect();
		} catch (err) {
		...
		describe("First call", async function () {
			this.timeout(3660000);
			it("should call startSwap", async () => {
				try {
					// this starts up the merkle tree's event filter
					await startEventFilter("SwapShield");
					// this calls your function! It returns the tx from the shield contract
	...
	// eslint-disable-next-line func-names
	describe("completeSwap", async function () {
		this.timeout(3660000);
		try {
			await web3.connect();
		} catch (err) {
		...
		describe("First call", async function () {
			this.timeout(3660000);
			it("should call completeSwap", async () => {
				try {
					// this starts up the merkle tree's event filter
					await startEventFilter("SwapShield");
					// this calls your function! It returns the tx from the shield contract
	...
	// eslint-disable-next-line func-names
	describe("quitSwap", async function () {
		this.timeout(3660000);
		try {
			await web3.connect();
		} catch (err) {
	...
	// eslint-disable-next-line func-names
	describe("withdraw_token", async function () {
		this.timeout(3660000);
		try {
			await web3.connect();
		} catch (err) {
		...
		describe("First call", async function () {
			this.timeout(3660000);
			it("should call withdraw_token", async () => {
				try {
					// this starts up the merkle tree's event filter
					await startEventFilter("SwapShield");
					// this calls your function! It returns the tx from the shield contract
