...
export default async function startSwap(
	...
	swapProposals_sharedAddress.swapTokenSentId = parseInt(
		tokenIdSent.integer,
		10
	);
	...
	swapProposals_sharedAddress.swapTokenRecievedId = parseInt(
	...
	swapProposals_sharedAddress.swapTokenRecievedAmount = parseInt(
	...
	const res = await generateProof("startSwap", allInputs);
